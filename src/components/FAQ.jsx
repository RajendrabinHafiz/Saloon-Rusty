  ...
  return (
    <div className="faq">
      ...
      <Item
        ...
        answer="This may be due to having a private steam profile or not owning Rust. It could also be that you may not have “#rustysaloon” in your steam name. Once you have updated your steam name, please log out and log back into the site. If the problem persists, please contact support."
      />
      <Item
...
const Item = (props) => {
  ...
  return (
    <div onClick={() => setCollapsed(!collapsed)} className={"faq__item " + (collapsed ? "faq__item--collapsed" : "")}>
      <div className="faq__item-question">
        {props.question} <img src={process.env.PUBLIC_URL + "/images/expand.svg"} alt="" />
      </div>
