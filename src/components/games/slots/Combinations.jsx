...
export default React.forwardRef((props, ref) => {
  ...
  return (
    <div class="slots__game-combinations">
      ...
      {/*
      <div class="slots__combinations-first-element">
      <SlotCombination elIndex={4} multiplier={defs.COMBINATIONS['Saloon:Saloon:Saloon']} combationItems={'Saloon:Saloon:Saloon'.split(':')} />
      </div>
      */}
